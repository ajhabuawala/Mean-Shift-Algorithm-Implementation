...
;	/opt/bbToolChain/usr/local/share/c6000/bin/opt6x /tmp/08197ep5wwd /tmp/08197Mwvkfk 
	.sect	".text"
	.clink
	.global	_main
...
$C$DW$T$37	.dwtag  DW_TAG_typedef, DW_AT_name("Char")
...
$C$DW$T$34	.dwtag  DW_TAG_structure_type
	.dwattr $C$DW$T$34, DW_AT_name("Task_TransferInfo_tag")
