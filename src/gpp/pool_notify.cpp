/**
@file   pool_notify.cpp
@brief  This file contains the implementation for Pool Notify
*/
 ...
 *  ============================================================================
 */
NORMAL_API DSP_STATUS pool_notify_Execute (IN Uint32 numIterations, Uint8 processorId, Uint8 fun)
{
    DSP_STATUS  status    = DSP_SOK ;

//  Start a exchange here ================================================================
    
    POOL_writeback (POOL_makePoolId(processorId, SAMPLE_POOL_ID),
                    pool_notify_DataBuf,
                    pool_notify_BufferSize);

    NOTIFY_notify (processorId,pool_notify_IPS_ID,pool_notify_IPS_EVENTNO,fun);
...
void pool_notify_Wait (IN Uint32 numIterations, Uint8 processorId)
{
